# Will attempt to perform a homework from Ely that consists in creating a code capable of printing all odd numbers from a starting value to an end value
...
# The user inputs will then form a list, since the num_fin is not inclusive I have added a +1, so it is included.
